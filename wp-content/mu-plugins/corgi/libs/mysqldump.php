...
/**
 * MySQL dump library by Diego Torres <ifsnop@github.com>
 * https://github.com/ifsnop/mysqldump-php
 */

class CorgiMysqldump
{
	...
	/**
	 * Constructor of CorgiMysqldump. Note that in the case of an SQLite database
	...
	)
	{
		$dumpSettingsDefault = array(
			...
			'databases' => false,
			'default-character-set' => CorgiMysqldump::UTF8,
			'disable-keys' => true,
	...
	/**
	 * Destructor of CorgiMysqldump. Unsets dbHandlers and database objects.
	 */
	...
	private function getDumpFileHeader()
	{
		...
		if (!$this->dumpSettings['skip-comments']) {
			...
			$header = "-- DB BACKUP by CORGI | Visit: https://corgi.pro" . PHP_EOL .
				"--" . PHP_EOL .
...
abstract class CompressMethod
{
	public static $enums = array(
		CorgiMysqldump::NONE,
		CorgiMysqldump::GZIP,
		CorgiMysqldump::BZIP2,
		CorgiMysqldump::GZIPSTREAM,
	);
